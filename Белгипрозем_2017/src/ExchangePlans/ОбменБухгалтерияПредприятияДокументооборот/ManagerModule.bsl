...
Функция ЗначенияПоУмолчаниюНаУзле(ВерсияКорреспондента, ИмяФормы) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ДокументооборотИспользоватьОграничениеПравДоступа") Тогда
		СтруктураНастроек.Вставить("ГруппаДоступаКорреспондентов", Справочники.ГруппыДоступаКорреспондентов.ПустаяСсылка());
	КонецЕсли;
...
Функция ОписаниеЗначенийПоУмолчанию(ЗначенияПоУмолчаниюНаУзле, ВерсияКорреспондента) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ОграничиватьДоступНаУровнеЗаписей") Тогда
		ТекстОписания = ТекстОписания + НСтр("ru = 'Группа доступа корреспондентов'") + ": ";
		Если ЗначениеЗаполнено(ЗначенияПоУмолчаниюНаУзле.ГруппаДоступаКорреспондентов) Тогда
			ТекстОписания = ТекстОписания + ЗначенияПоУмолчаниюНаУзле.ГруппаДоступаКорреспондентов;
		Иначе
