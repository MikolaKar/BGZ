...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = 'Создать обмен внешними поручениями'");
...
Функция ПрименитьИзменениеКИнформационнойБазеПриКоллизииИзменений(УзелИнформационнойБазы, Объект) Экспорт
...
Функция КраткаяИнформацияПоОбмену() Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Предназначен для обмена внешними задачами.'");
