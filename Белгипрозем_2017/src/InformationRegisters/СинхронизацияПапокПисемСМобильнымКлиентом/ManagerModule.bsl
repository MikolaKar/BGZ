	...
	Для каждого УчетнаяЗаписьПользователя Из МассивУчетныеЗаписи Цикл
		...
		Для Каждого ПапкаУчетнойЗаписи Из папкиУчетнойЗаписи Цикл
			...
			Если МассивПапок.Найти(ПапкаУчетнойЗаписи.Папка) = Неопределено Тогда
				...
				РодительПапки = ОбщегоНазначения.ПолучитьЗначениеРеквизита(ПапкаУчетнойЗаписи.Папка, "Родитель");
				Пока ЗначениеЗаполнено(РодительПапки) Цикл
					...
					КонецЕсли;
					РодительПапки = ОбщегоНазначения.ПолучитьЗначениеРеквизита(РодительПапки, "Родитель");
				КонецЦикла;
			КонецЕсли;			
		КонецЦикла;
	КонецЦикла;
...
Процедура ЗаписатьПапки(МассивПапок) Экспорт
