...
//1С-Минск
	Если ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ПаспортРФ ИЛИ ВидДокумента = Справочники.ВидыДокументовФизическихЛиц.ПаспортРБ Тогда
		Возврат Истина;
	КонецЕсли;
...
// функция возвращает структуру с данными паспорта на указанную дату 
//
//	Физлицо			- физическое лицо, для которого необходимо получить данные
//	Дата			- дата, на которую необходимо получить данные
//
// Возвращаемое значение
//	Структура с данными паспорта
//
Функция ПаспортныеДанныеФизлица(Физлицо, Дата = Неопределено) Экспорт
    ...
    ДанныеПаспорта = Новый Структура("Серия, Номер, ДатаВыдачи, СрокДействия, КемВыдан");
...
КонецФункции // ПаспортныеДанныеФизлица()
