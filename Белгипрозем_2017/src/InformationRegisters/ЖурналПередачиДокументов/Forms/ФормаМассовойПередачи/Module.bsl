...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого Строка Из Документы Цикл
		...
		КоличествоЭкземпляров = ОбщегоНазначения.ПолучитьЗначениеРеквизита(Строка.Документ, 
...
Процедура ДобавитьРеквизитТипПользователя()
    ...
    Если ЗначениеЗаполнено(Пользователь) Тогда
		ИмяТипаПользователя = Строка(ТипЗнч(Пользователь));
...
Процедура ТипПользователяПриИзменении(Элемент)
    ...
    Пользователь = ВыбЭлемент.Значение;    
