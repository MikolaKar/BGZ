...
Функция ПолучитьПрофильДляОтправки(Наименование) Экспорт
	...
	Хранилище = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("РаботаСПочтой", "ПрофилиДляОтправки");	
...
Функция ПолучитьПрофильДляЗагрузки(Наименование) Экспорт
	...
	Хранилище = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("РаботаСПочтой", "ПрофилиДляЗагрузки");
	Если ТипЗнч(Хранилище) <> Тип("СписокЗначений") Тогда
		Хранилище = Новый СписокЗначений;
	КонецЕсли;
