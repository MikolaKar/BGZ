...
Процедура ПриПолученииСпискаПредупрежденийЗавершенияРаботы(Предупреждения) Экспорт
	...
	ФормаОбработки = "Обработка.РезервноеКопированиеИБ.Форма.РезервноеКопированиеДанных";
	
	ДействиеПриУстановленномФлажке = Новый Структура("Форма, ПараметрыФормы", ФормаОбработки, ПараметрыФормы);
	СтруктураПредупреждения = Новый Структура("ТекстФлажка, ДействиеПриУстановленномФлажке, Приоритет", 
		ТекстФлажка, ДействиеПриУстановленномФлажке, 70);
