...
Процедура ЗаполнитьМассивПлановОбмена(ПланыОбменаДляВыбора) Экспорт
	...
	ПланыОбменаДляВыбора.Добавить("ОбменУправлениеНебольшойФирмойДокументооборот");
	ПланыОбменаДляВыбора.Добавить("ОбменУправлениеТорговлейДокументооборот");
	ПланыОбменаДляВыбора.Добавить("ОбменУправлениеПредприятиемДокументооборот");
