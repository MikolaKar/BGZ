...
Функция ВсеКоллеги() Экспорт
	...
	|	РегистрСведений.СведенияОПользователях КАК СведенияОПользователях
	|ГДЕ
	|	СведенияОПользователях.Подразделение В
	|			(ВЫБРАТЬ
	|				РегистрСведений.СведенияОПользователях.Подразделение
	|			ИЗ
	|				РегистрСведений.СведенияОПользователях
	|			ГДЕ
	|				РегистрСведений.СведенияОПользователях.Пользователь = &Пользователь)
	|	И СведенияОПользователях.Пользователь <> &Пользователь
