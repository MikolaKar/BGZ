...
Функция ВЧисло(х) Экспорт
	у = Новый ОписаниеТипов("Число");
	Возврат у.ПривестиЗначение(х);
Конецфункции
...
Функция ОбщиеПараметрыБазовойФункциональности() Экспорт
	...
	ОбщиеПараметры.Вставить("МинимальноНеобходимаяВерсияПлатформы", "8.3.5.1517");
...
// Для использования в процедуре ЗаполнитьТаблицуПереименованияОбъектовМетаданных
