...
Процедура ДокументПриЧтенииНаСервере(Форма) Экспорт
	...
	Форма.ЯвляетсяКомплектом = ЗначениеЗаполнено(Форма.Объект.ВидДокумента) И Форма.Объект.ВидДокумента.ЯвляетсяКомплектомДокументов;
...
Процедура ДокументПриСозданииНаСервере(Форма) Экспорт
	...
	Иначе
		Форма.Элементы.Утвердил.Видимость = Истина;
	КонецЕсли;
