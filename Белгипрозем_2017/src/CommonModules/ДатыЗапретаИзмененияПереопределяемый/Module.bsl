...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
  ...
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ОплатаРабот", "Дата", "Оплата", "");
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ВозвратОплаты", "Дата", "Оплата", "");
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.РеестрТекущихПлатежей", "Дата", "Оплата", "");
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ВедомостьАктирования",   "Дата", "Актирование", "");
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.мАктирование",   "Дата", "Актирование", "");
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.мРасчетЗарплаты", "Дата", "РасчетЗарплаты", "");
