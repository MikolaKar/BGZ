...
Процедура ПараметрыРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	ЗапрашиватьПароль = Ложь;
	ВходБезПароляЗапрещен = Константы.ЗапрещатьВходВПрограммуБезПароля.Получить();
	Если ВходБезПароляЗапрещен Тогда
		ТекущийПользовательИБ = ПользователиИнформационнойБазы.ТекущийПользователь();
		Если ТекущийПользовательИБ.АутентификацияСтандартная И Не ТекущийПользовательИБ.ПарольУстановлен Тогда
			ЗапрашиватьПароль = Истина;
		КонецЕсли;
	КонецЕсли;
	
	Параметры.Вставить("ЗапроситьПароль", ЗапрашиватьПароль);
