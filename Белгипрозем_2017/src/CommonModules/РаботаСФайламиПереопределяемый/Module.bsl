...
Функция ВозможноЗанятьФайл(ДанныеФайла, СтрокаОшибки = "") Экспорт 
	...
	Если ТипЗнч(ДанныеФайла) = Тип("СправочникСсылка.Файлы") Тогда 
		ВладелецФайла = ОбщегоНазначения.ПолучитьЗначениеРеквизита(ДанныеФайла, "ВладелецФайла");
	...
	Если ЭтоБизнесПроцесс Тогда
		СостояниеБП = ОбщегоНазначения.ПолучитьЗначениеРеквизита(ВладелецФайла, "Состояние");
	...
	Если ЭтоДокумент Тогда
		ДокументПодписанЭП = ОбщегоНазначения.ПолучитьЗначениеРеквизита(ВладелецФайла, "ПодписанЭП");
...
Функция ВозможноУдалитьФайл(ФайлОбъект, СтрокаОшибки = "") Экспорт 
	...
	Если ОбщегоНазначения.ПолучитьЗначениеРеквизита(ВладелецФайла, "ПодписанЭП")
