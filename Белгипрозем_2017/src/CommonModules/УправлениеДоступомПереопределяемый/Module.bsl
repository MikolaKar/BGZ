...
Процедура ЗаполнитьПоставляемыеПрофилиГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	ОписаниеПрофиля.Наименование  = "Делопроизводители";
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеКорреспондентов");
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеГруппДоступаКорреспондентов"); // Для ограничения по виду доступа "ГруппыДоступаКорреспондентов"
	...
	ОписаниеПрофиля.ВидыДоступа.Добавить("ВидыВнутреннихДокументов");
	ОписаниеПрофиля.ВидыДоступа.Добавить("ВидыВходящихДокументов");
	ОписаниеПрофиля.ВидыДоступа.Добавить("ВидыИсходящихДокументов");
	ОписаниеПрофиля.ВидыДоступа.Добавить("ГрифыДоступа");
	ОписаниеПрофиля.ВидыДоступа.Добавить("ГруппыДоступаКорреспондентов");
	ОписаниеПрофиля.ВидыДоступа.Добавить("ГруппыДоступаФизическихЛиц");
	...
	ОписаниеПрофиля.Наименование  = "Контроль задач и бизнес-процессов";
	...
	ОписаниеПрофиля.Наименование  = "Ответственные за НСИ";
	...
	ОписаниеПрофиля.Наименование  = "Пользователи";
	ОписаниеПрофиля.Роли.Добавить("БазовыеПрава");
	ОписаниеПрофиля.Роли.Добавить("БазовыеПраваПользователя");
	ОписаниеПрофиля.Роли.Добавить("РаботаСПапкамиФайлов");
	...
	ОписаниеПрофиля.Роли.Добавить("РегистрацияВнутреннихДокументов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеКорреспондентов");
	...
	ОписаниеПрофиля.Наименование  = "Работа с входящими и исходящими документами";
	...
	ОписаниеПрофиля.Наименование  = "Руководители подразделений";
	...
	ОписаниеПрофиля.Наименование  = "Контроль ежедневных отчетов";
	...
	ОписаниеПрофиля.Наименование  = "Руководители проектов";
	...
	ОписаниеПрофиля.Наименование  = "Ответственные за ЭДО";
...
Процедура ЗаполнитьСвойстваВидаДоступа(Знач Свойства) Экспорт
	...
	ИначеЕсли Свойства.ВидДоступа = ПланыВидовХарактеристик.ВидыДоступа.ГруппыДоступаКорреспондентов Тогда
		Свойства.Таблицы.Добавить("Справочник.ГруппыДоступаКорреспондентов");
		Свойства.ВидДоступаБезГруппЗначенияДоступа            = Истина;
		Свойства.ВидДоступаЕдинственныйДляТипаЗначенияДоступа = Истина;
