...
//Параметры: 
//			ИскомыйОбъект - ссылка на объект любого типа. может быть реквизитом Объект формы элемента.
//			СтруктураПоиска - структура
//				<Название реквизита> - имя реквизита, по которому ищутся дубли
//				Степень похожести - способ сравнения значений
//Возвращает:
//			Массив найденных объектов, у которых совпадает хотя бы один реквизит
