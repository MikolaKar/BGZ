...
// Возвращает имя профиля безопасности для внешнего модуля.
// Формируемое имя должно обеспечивать уникальность в пределах кластера серверов.
...
Функция ИмяПрофиляБезопасности(Знач ВнешнийМодуль) Экспорт
	...
	Возврат "Extension_" + Строка(ВнешнийМодуль.УникальныйИдентификатор()); // Не локализуется
