...
//                 ДанныеФормыСтруктура (по типу объекта).
//
//  ПоляНадписей - Булево - начальное значение Ложь, если указать Истина,
//                 то вместо полей ввода на форме будут созданы поля надписей.
//
Процедура ЗаполнитьДополнительныеРеквизитыВФорме(Форма, Объект = Неопределено, ПоляНадписей = Ложь) Экспорт
	...
	Для Каждого ОписаниеСвойства Из ОписаниеСвойств Цикл
		...
		Если НЕ ПоляНадписей И ОписаниеСвойства.ИмяРеквизитаСвойство <> "" Тогда
