...
Функция УстановитьВнешнееСоединениеСБазой(СтруктураНастроек) Экспорт
	...
	Если НетПолныхПрав Тогда
		Результат.ПодробноеОписаниеОшибки = НСтр("ru = 'У пользователя другой программы отсутствует роль ""Полные права"".'");
...
Функция ИмяПрофиляБезопасности(Знач ВнешнийМодуль) Экспорт
	...
	ШаблонИмениПрофиляБезопасности = "Exchange_[ИмяПланаОбмена]_[УникальныйИдентификатор]";
	ИмяПрофиляБезопасности = СтрЗаменить(ШаблонИмениПрофиляБезопасности, "[ИмяПланаОбмена]", ВнешнийМодуль.Имя);
	ИмяПрофиляБезопасности = СтрЗаменить(ИмяПрофиляБезопасности, "[УникальныйИдентификатор]", ВнешнийМодуль.УникальныйИдентификатор());
