...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Запрос.УстановитьПараметр("ПолноправныйОтветственный", ПользователиСерверПовтИсп.ЭтоПолноправныйПользовательИБ());
	...
	|ГДЕ
	|	ГруппыДоступа.Ссылка <> ЗНАЧЕНИЕ(Справочник.ГруппыДоступа.Администраторы)
