...
//    Структура - содержит поля "Ссылка", "Код", "Наименование", "НаименованиеПолное", "КодАльфа2", "КодАльфа3".
...
//
// Возвращаемое значение:
//    Структура, Неопределено - в случае успеха - структура с полями "Код", "Наименование", "НаименованиеПолное", "КодАльфа2", "КодАльфа3".
...
//
// Параметры:
//    Отбор  - Структура - содержит поле Код для поиска страны в классфикаторе
//    Данные - Структура - для заполнения оставшихся полей создаваемого объекта.
//
// Возвращаемое значение:
//     СправочникСсылка - ссылка на созданый элемент
//
