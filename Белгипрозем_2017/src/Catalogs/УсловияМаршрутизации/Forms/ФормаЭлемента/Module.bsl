...
Процедура ПроверитьВыражение(Команда)
	...
	ПараметрыФормы = Новый Структура("ТипОбъекта, Выражение", Объект.ТипОбъекта, Объект.ВыражениеУсловия);
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ПроверитьВыражениеПродолжение",
		ЭтотОбъект);
	ОткрытьФорму(
		"Справочник.УсловияМаршрутизации.Форма.ПроверкаВыражения", 
		ПараметрыФормы, 
		ЭтаФорма,,,,
		ОписаниеОповещения,
