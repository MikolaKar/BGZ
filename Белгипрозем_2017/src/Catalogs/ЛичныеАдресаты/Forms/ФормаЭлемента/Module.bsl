...
Процедура ПреобразоватьВКорреспондента(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ПреобразоватьВКорреспондентаПродолжение",
		ЭтотОбъект,
		ПараметрыФормы);

	ОткрытьФорму("Справочник.ЛичныеАдресаты.Форма.ВыборКорреспондентаКонтактноеЛицо", ПараметрыФормы,,,,,
		ОписаниеОповещения, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
		
КонецПроцедуры

&НаКлиенте
Процедура ПреобразоватьВКорреспондентаПродолжение(КодВозврата, Параметры) Экспорт 
	
	Если ТипЗнч(КодВозврата) = Тип("СправочникСсылка.Корреспонденты") 
		...
		Если РаботаСЛичнымиАдресатами.ЗаполнитьКонтактИЗаменитьСсылки(ЛичныйАдресат, КодВозврата, УникальныйИдентификатор, СтрокаОшибки) Тогда
			...
			ТекстОповещения = ?(ТипЗнч(КодВозврата) = Тип("СправочникСсылка.Корреспонденты"),
				"корреспондента", "контактное лицо");
			ТекстОповещения = НСтр("ru = 'Адресат преобразован в " + ТекстОповещения + "'");			
