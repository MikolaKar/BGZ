...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		Для Каждого Тип Из Перечисления.ТипыОбъектов Цикл
			Если Тип = Перечисления.ТипыОбъектов.Корреспонденты Тогда
				Продолжить;
			КонецЕсли;
			НоваяСтрока = ТипыДанныхДляПравила.Добавить();
			НоваяСтрока.ТипДанных = Тип;
	...
	Если Объект.Используется Тогда
		КомментарийКИспользуется = НСтр("ru = 'Данное правило будет использоваться при автокатегоризации.'");
	Иначе
		КомментарийКИспользуется = НСтр("ru = 'Данное правило не будет использоваться при автокатегоризации.'");
	КонецЕсли;
