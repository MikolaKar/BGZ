...
Процедура Импорт(Команда)
	...
	РаботаСФайламиКлиент.ПроверитьПредельныйРазмерФайлов(Обработчик, ПараметрыВыполнения.ВыбранныеФайлы, ПараметрыВыполнения.Рекурсивно, ПараметрыВыполнения.ПсевдоФайловаяСистема, ПараметрыВыполнения.РежимЗагрузки);
...
Процедура ИмпортФайловПослеПроверкиРазмеров(Результат, ПараметрыВыполнения) Экспорт
	...
	ОповеститьОбИзменении(Тип("СправочникСсылка.ВнутренниеДокументы"));
