...
Процедура ПерезаполнитьДерево(ТолькоСнятьФлажки)
	...
	Если КоличествоВариантов = 0 Тогда
		...
		РезультатВыполнения.ВыводСообщения.ПутьКРеквизитуФормы = "ИзменяемыеВарианты";
	...
	Если КоличествоОшибок > 0 Тогда
		...
		КоличествоВариантов = ИзменяемыеВарианты.Количество();
		Если КоличествоВариантов = 0 Тогда
			ТекстСообщения = НСтр("ru = 'После проверки все варианты отчетов были исключены из списка выбранных.
			|Необходимо заполнить поле ""Варианты отчетов"".'");
			Элементы.ДеревоПодсистем.Доступность = Ложь;
		Иначе
			ТекстСообщения = СтрЗаменить(
				НСтр("ru = 'После проверки варианты отчетов (%1 шт.) были исключены из списка выбранных.'"),
				"%1",
		...
		РезультатВыполнения.Вставить("ВыводПредупреждения", 
			Новый Структура("Использование, Текст, ПутьКРеквизитуФормы, ТекстОшибок", Истина, ТекстСообщения, "ИзменяемыеВарианты", ТекстОшибок)
		);
		РезультатВыполнения = Новый ФиксированнаяСтруктура(РезультатВыполнения);
	Иначе
		Элементы.ДеревоПодсистем.Доступность = Истина;
