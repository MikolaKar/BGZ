...
Процедура ОбработкаКоманды(МассивВариантов, ПараметрыВыполненияКоманды)
	...
	ПараметрыОбработчика.Вставить("КоличествоВариантов", КоличествоВариантов);
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ОбработчкаКомандыПродолжение",
		ЭтотОбъект,
...
&НаКлиенте
Процедура ОбработчкаКомандыПродолжение(Ответ, Параметры) Экспорт
	...
	КоличествоВариантов	= Параметры.КоличествоВариантов;
