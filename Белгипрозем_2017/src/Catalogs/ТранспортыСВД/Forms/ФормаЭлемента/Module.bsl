...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаДоставки.Видимость =
	...
	//МиСофт+
	ИдентификационныйНомерСистемы = Константы.ИдентификационныйНомерСистемы.Получить();
	//МиСофт-
...
&НаКлиенте
Процедура ИдентификационныйНомерСистемыПриИзменении(Элемент)
	ИдентификационныйНомерСистемыПриИзмененииНаСервере();
КонецПроцедуры

&НаСервере
Процедура ИдентификационныйНомерСистемыПриИзмененииНаСервере()
	Константы.ИдентификационныйНомерСистемы.Установить(ИдентификационныйНомерСистемы);
КонецПроцедуры
