...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ЭтоНовый() Тогда
		...
		Если ВладелецИзменился() Тогда
			...
			ПрежниеЗначенияРеквизитов = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(Ссылка, ИменаРеквизитов);
	...
	Если Ссылка.ВладелецФайла <> ВладелецФайла Тогда
		...
		Если ВладелецФайлаЭтоДокумент Тогда
			ВладелецФайлаПодписанЭП = ОбщегоНазначения.ПолучитьЗначениеРеквизита(Ссылка.ВладелецФайла, "ПодписанЭП");
		...
		Если НовыйВладелецФайлаЭтоДокумент Тогда
			НовыйВладелецФайлаПодписанЭП = ОбщегоНазначения.ПолучитьЗначениеРеквизита(ВладелецФайла, "ПодписанЭП");
...
Функция ВладелецИзменился()
	...
	Если ОбщегоНазначения.ПолучитьЗначениеРеквизита(Ссылка, "ВладелецФайла") = ВладелецФайла Тогда
		Возврат Ложь;
	Иначе
		Возврат Истина;
	КонецЕсли;	
