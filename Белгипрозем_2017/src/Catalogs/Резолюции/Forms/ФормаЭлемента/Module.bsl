...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВидДокумента = ОбщегоНазначения.ПолучитьЗначениеРеквизита(Объект.Документ, "ВидДокумента");
	ПодписыватьРезолюциюЭП = ОбщегоНазначения.ПолучитьЗначениеРеквизита(ВидДокумента, "ПодписыватьРезолюцииЭП");
...
Процедура АвторРезолюцииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	РаботаСПользователямиКлиент.ВыбратьИсполнителя(Элемент, Объект.АвторРезолюции,,Истина,,,,
		Объект.ОсновнойОбъектАдресацииАвтора, Объект.ДополнительныйОбъектАдресацииАвтора);
...
Функция ПолучитьДанныеЭП()
	...
	ДанныеЭП = Новый Структура("КомуВыданСертификат, ДатаПодписи, Комментарий, Статус, Объект, АдресПодписи,
		...
		|СертификатДействителен, ДатаПроверкиПодписи, ТекстОшибкиПроверкиПодписи");
	...
	ЗаполнитьЗначенияСвойств(ДанныеЭП, ЭП);
	
	ДвоичныеДанные = ЭП.Подпись.Получить();
