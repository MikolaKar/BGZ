...
Функция НайтиПоКодуКлассификаторЕдиницИзмерения(КодЧисловой)
	 ...
	 Возврат Справочники.мКлассификаторЕдиницИзмерения.НайтиПоКоду(КодЧисловой);
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Справочники.мКлассификаторЕдиницИзмерения.ПолучитьМакет("КлассификаторЕдиницИзмерения");
...
Процедура ПолеТабличногоДокументаОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если НЕ Ссылка.Пустая() Тогда
		...
		Если Ответ = КодВозвратаДиалога.Да Тогда
			 ...
			 ОткрытьФорму("Справочник.мКлассификаторЕдиницИзмерения.Форма.ФормаЭлемента", ПараметрыОткрытия);
