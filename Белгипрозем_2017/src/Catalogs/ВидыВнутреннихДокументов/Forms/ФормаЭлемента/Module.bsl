...
Процедура УстановитьДоступностьОпций(Форма)
	...
	Если Форма.Объект.ЯвляетсяДоговором Тогда
		Установить(Форма.Объект.ВестиУчетПоКорреспондентам, Истина);
		Установить(Форма.Объект.УчитыватьСрокДействия, Истина);
		Установить(Форма.Объект.УчитыватьСуммуДокумента, Истина);
		Установить(Форма.Объект.УчитыватьНедействующиеДокументы, Истина);
		Установить(Форма.Объект.ЯвляетсяКомплектомДокументов, Ложь);
		Установить(Форма.Объект.ОбязательноеУказаниеОтветственного, Истина);
	КонецЕсли;
	...
	УстановитьДоступностьОпции(Форма, "ЯвляетсяКомплектомДокументов",
		...
		И Не Форма.Объект.ВестиУчетПоКорреспондентам
	...
	УстановитьДоступностьОпции(Форма, "УчетПоКорреспондентам",
	...
	Если Не Форма.Объект.УчитыватьСуммуДокумента Тогда
		Установить(Форма.Объект.ВестиУчетПоСтатьямДДС, Ложь);
	КонецЕсли;
	УстановитьДоступностьОпции(Форма, "ВестиУчетПоСтатьямДДС",
		Форма.Объект.УчитыватьСуммуДокумента);
...
&НаКлиентеНаСервереБезКонтекста
Процедура Установить(Опция, Значение)
	Если Опция <> Значение Тогда
		Опция = Значение;
	КонецЕсли;
КонецПроцедуры
