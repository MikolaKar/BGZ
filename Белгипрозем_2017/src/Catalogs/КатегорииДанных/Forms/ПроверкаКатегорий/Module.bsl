...
Функция ПолучитьКатегорииОбъекта(ОбъектСсылка)
	...
	Для Каждого Запись Из НаборЗаписей Цикл 
		ДанныеОКатегории = Новый Структура("ПолноеНаименование, Ссылка, Персональная, Автор", РаботаСКатегориямиДанных.ПолучитьПолныйПутьКатегорииДанных(Запись.КатегорияДанных), Запись.КатегорияДанных, Запись.КатегорияДанных.Персональная, Запись.Автор);
