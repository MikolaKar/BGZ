...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РаботаСФайламиВызовСервера.ПолучитьИспользоватьЭлектронныеПодписиИШифрование() = Ложь Тогда
		...
		Элементы.СписокФайлы.ПодчиненныеЭлементы.Зашифрован.Видимость = Ложь;
	КонецЕсли;
...
Процедура ОткрытьФайлВыполнить()
	...
	ДанныеФайла = РаботаСФайламиВызовСервера.ПолучитьДанныеФайлаДляОткрытия(Элементы.СписокФайлы.ТекущаяСтрока, Неопределено, УникальныйИдентификатор);
...
Процедура ЗакончитьРедактирование(Команда)
	...
	РаботаСФайламиКлиент.ЗакончитьРедактированиеСОповещением(
		...
		Элементы.СписокФайлы.ТекущиеДанные.ХранитьВерсии,
		Элементы.СписокФайлы.ТекущиеДанные.РедактируетТекущийПользователь,
		Элементы.СписокФайлы.ТекущиеДанные.Редактирует,
		Элементы.СписокФайлы.ТекущиеДанные.Автор);
...
Процедура СохранитьКак(Команда)
	...
	ИначеЕсли Элементы.СписокФайлы.ВыделенныеСтроки.Количество() = 1 Тогда
		ДанныеФайла = РаботаСФайламиВызовСервера.ПолучитьДанныеФайлаДляСохранения(Элементы.СписокФайлы.ТекущаяСтрока, Неопределено, УникальныйИдентификатор);
...
Процедура ОбновитьИзФайлаНаДиске(Команда)
	...
	ДанныеФайла = РаботаСФайламиВызовСервера.ПолучитьДанныеФайлаИРабочийКаталог(Элементы.СписокФайлы.ТекущаяСтрока);
...
Процедура СохранитьВместеСЭП(Команда)
	...
	ДанныеФайла = РаботаСФайламиВызовСервера.ПолучитьДанныеФайлаДляСохранения(Элементы.СписокФайлы.ТекущаяСтрока);
...
Функция ФайловыеКомандыДоступны()
	...
	Если Элементы.СписокФайлы.ТекущаяСтрока = Неопределено Тогда 
		Возврат Ложь;
	КонецЕсли;
...
Процедура ПодписатьЗавершение(Результат, Параметры) Экспорт
	...
	ИмяСписка = СтрЗаменить(Элементы.СтраницыСпискиОбъектов.ТекущаяСтраница.Имя, "Страница", "");
	Если Элементы["Список" + ИмяСписка].ТекущиеДанные = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	РаботаСЭПКлиент.ИнформироватьОПодписании(МассивДанныхДляЗанесенияВРегистр, 
		Элементы["Список" + ИмяСписка].ТекущаяСтрока);
