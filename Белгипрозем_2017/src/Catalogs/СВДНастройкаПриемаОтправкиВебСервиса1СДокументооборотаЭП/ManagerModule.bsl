	...
	Если МассивФайлов.Количество() <> 1 Тогда
		...
		Если МассивФайлов.Количество() = 0 Тогда
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Отправка исходящих сообщений СВД'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Функция ПолучитьСообщения(НастройкаПриемаОтправки, Транспорт) Экспорт
	...
	Пока Истина Цикл
		...
		Исключение
			...
			СообщениеОбОшибке = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'СВД. Получение сообщения с сервера. Веб-сервис'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,
