...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		РеквизитыСвойства = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(
			Объект.Владелец, "ДополнительныеЗначенияСВесом, ВладелецДополнительныхЗначений");
		
		Если ЗначениеЗаполнено(РеквизитыСвойства.ВладелецДополнительныхЗначений) Тогда
			ПоказатьВес = ОбщегоНазначения.ПолучитьЗначениеРеквизита(
				РеквизитыСвойства.ВладелецДополнительныхЗначений, "ДополнительныеЗначенияСВесом");
		Иначе
			ПоказатьВес = РеквизитыСвойства.ДополнительныеЗначенияСВесом;
		КонецЕсли;
	КонецЕсли;
