...
Функция ЗаписатьСервер()
	...
	Попытка
		...
		Для каждого Эл Из ТаблицаПрав Цикл
			...
			Строка.ЧтениеПапокИМероприятий = ПреобразоватьПравоВБулево(Эл.ПравоЧтения);
			Строка.ДобавлениеПапокИМероприятий = ПреобразоватьПравоВБулево(Эл.ПравоДобавления); 
			Строка.ИзменениеПапокИМероприятий = ПреобразоватьПравоВБулево(Эл.ПравоИзменения);
			Строка.ИзменениеПапокМероприятий = ПреобразоватьПравоВБулево(Эл.ПравоИзмененияПапок);
			Строка.ПометкаУдаленияПапокИМероприятий = ПреобразоватьПравоВБулево(Эл.ПравоУдаленияДанных);
...
Процедура ДобавитьПравоВТаблицуПрав(ОписаниеПрава)
	...
	// Право ЧтениеПапокИМероприятий
	Если ОписаниеПрава.ЧтениеПапокИМероприятий = Ложь Тогда
		// Запрещено
		СтрокаПрав.ПравоЧтения = 2;
	ИначеЕсли ОписаниеПрава.ЧтениеПапокИМероприятий = Истина Тогда
		// Разрешено
	...
	// Право ДобавлениеПапокИМероприятий
	Если ОписаниеПрава.ДобавлениеПапокИМероприятий = Ложь Тогда
		// Запрещено
		СтрокаПрав.ПравоДобавления = 2;
	ИначеЕсли ОписаниеПрава.ДобавлениеПапокИМероприятий = Истина Тогда
		// Разрешено
	...
	// Право ИзменениеПапокМероприятий
	Если ОписаниеПрава.ИзменениеПапокМероприятий = Ложь Тогда
		// Запрещено
		СтрокаПрав.ПравоИзмененияПапок = 2;
	ИначеЕсли ОписаниеПрава.ИзменениеПапокМероприятий = Истина Тогда
		// Разрешено
	...
	// Право ИзменениеПапокИМероприятий
	Если ОписаниеПрава.ИзменениеПапокИМероприятий = Ложь Тогда
		// Запрещено
		СтрокаПрав.ПравоИзменения = 2;
	ИначеЕсли ОписаниеПрава.ИзменениеПапокИМероприятий = Истина Тогда
		// Разрешено
	...
	// Право ПометкаУдаленияПапокИМероприятий
	Если ОписаниеПрава.ПометкаУдаленияПапокИМероприятий = Ложь Тогда
		// Запрещено
		СтрокаПрав.ПравоУдаленияДанных = 2;
	ИначеЕсли ОписаниеПрава.ПометкаУдаленияПапокИМероприятий = Истина Тогда
		// Разрешено
