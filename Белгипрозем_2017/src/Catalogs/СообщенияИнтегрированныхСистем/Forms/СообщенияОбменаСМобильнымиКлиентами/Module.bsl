...
Процедура ОчиститьПереданныеСообщенияПродолжение(Ответ, Параметры) Экспорт
	...
	Если ЗначениеЗаполнено(МобильныйКлиент) Тогда
		ОбменСМобильными.УдалениеСообщенийИнтеграцииПоКлиенту(МобильныйКлиент);
	Иначе
		ОбменСМобильными.УдалениеСообщенийИнтеграцииСМобильнымКлиентом();
	КонецЕсли;
...
Процедура ПользовательПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Пользователь) Тогда
		...
		Список.Параметры.УстановитьЗначениеПараметра("ОграничиватьПоКлиенту", Ложь);
		МобильныеКлиенты = 
			ОбменСМобильнымиПовтИсп.ПолучитьУзлыОбменаПоВладельцу(Пользователь);
