...
Процедура ПередЗаписью(Отказ)
	...
	Иначе 
		Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Ссылка, "ПометкаУдаления, Подразделение");
...
Процедура ПриЗаписи(Отказ)
	...
	Если ДополнительныеСвойства.Свойство("Подразделение") 
		...
		Пока Выборка.Следующий() Цикл 
			...
			ЗаблокироватьДанныеДляРедактирования(РазделНоменклатурыДелОбъект.Ссылка);
