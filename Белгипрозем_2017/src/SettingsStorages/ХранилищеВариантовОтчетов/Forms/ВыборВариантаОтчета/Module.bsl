...
Процедура ДеревоВариантовОтчетаПередУдалением(Элемент, Отказ)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения(
		"ДеревоВариантовОтчетаПередУдалениемПродолжение",
		ЭтотОбъект,
...
&НаКлиенте
Процедура ДеревоВариантовОтчетаПередУдалениемПродолжение(Результат, Параметры) Экспорт 
	
	Если Результат = КодВозвратаДиалога.Да Тогда
		УдалитьВариантНаСервере(Параметры.Вариант.Ссылка, Параметры.Вариант.ИндексКартинки);
	КонецЕсли;
...
&НаКлиенте
Процедура ВыбратьИЗакрытьПродолжение(Результат, Параметры) Экспорт 
