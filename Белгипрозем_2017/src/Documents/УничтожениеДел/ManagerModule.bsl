...
Функция ПечатьАкта(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	//МиСофт+
	|	УничтожениеДел.Подразделение КАК Подразделение
	//МиСофт-
	|ИЗ
	...
	//МиСофт+
	Макет = Документы.УничтожениеДел.ПолучитьМакет("АктРБ");
	//МиСофт-
	...
	Пока ВыборкаСсылка.Следующий() Цикл
		...
		//МиСофт+
		ОбластьПодвал.Параметры.КоличествоДел = Формат(КоличествоЕдиницХранения, "ЧГ=") + " (" + ЧислоПрописью(КоличествоЕдиницХранения, , ",,,,,,,,0") + ")";
		//МиСофт-
