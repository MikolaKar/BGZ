...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщаяПроизводительностьСистемы.Пустая() Тогда
		Объект.ОбщаяПроизводительностьСистемы = "Общая производительность системы";
	Иначе
...
Процедура ЭкспортДанных(Команда)
	ОписаниеОповещения = Новый ОписаниеОповещения("ВыбратьФайлЭкспортаПредложено", ЭтаФорма);
