...
&НаСервереБезКонтекста
Функция ВыполнитьПоискСервер(УникальныйИдентификатор, Знач УсловияПоискаПисем, ИскатьВсе = Ложь)
...
&НаСервере
Функция СохранитьПапкуПоиска(ПапкаПоиска)
...
Процедура ВыполнитьПоискКлиентПродолжение(Ответ, Параметры) Экспорт
	...
	РезультатПоиска = ВыполнитьПоискСервер(УникальныйИдентификатор, УсловияПоискаПисем, ИскатьВсе);
...
Процедура СохранитьКакПапкуПоискаПродолжение(Результат, Параметры) Экспорт
	...
	ЭтоНоваяПапкаПоиска = СохранитьПапкуПоиска(Результат); 
