...
Процедура БыстрыйОбменВыгрузитьЭД(МассивСтруктурОбмена, СтруктураПараметров)
	...
	Иначе
		...
		Если МассивСтруктурОбмена.Количество() > 1 Тогда
			ТемаПисьма = "Пакеты электронных документов";
		Иначе
...
Процедура Декорация1Нажатие(Элемент)
	...
	Если ТаблицаДанных.Количество() > 1 Тогда
		...
		Для Каждого СтрокаДанных Из ТаблицаДанных Цикл
			...
			СтруктураПараметров.Вставить("ПолноеИмяДопФайла", СтрокаДанных.ПолноеИмяДопФайла);
			СтруктураПараметров.Вставить("ИдентификаторДопФайла", СтрокаДанных.ИдентификаторДопФайла);
