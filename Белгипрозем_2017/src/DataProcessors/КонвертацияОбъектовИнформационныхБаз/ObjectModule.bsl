...
Перем СоответствиеДокументовДляОтложенногоПроведения; // Соответствие для хранения дополнительных свойств документов после загрузки данных
...
//
Функция ПолучитьИнформациюОПравилах(ЭтоПравилаКорреспондента = Ложь, РежимСовместимости = Ложь) Экспорт
	...
	РежимСовместимости = (Конвертация.РежимСовместимости = ""
		Или Конвертация.РежимСовместимости = "РежимСовместимостиСБСП20");
	
	СтрокаИнформации = НСтр("ru = 'Правила конвертации %1 от %21:
						|Конфигурация источник: %3
						|Конфигурация приемник: %4'");
	...
	Возврат СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(СтрокаИнформации,
							?(ЭтоПравилаКорреспондента, Нстр("ru = 'корреспондента'"), Нстр("ru = 'этой программы'")),
