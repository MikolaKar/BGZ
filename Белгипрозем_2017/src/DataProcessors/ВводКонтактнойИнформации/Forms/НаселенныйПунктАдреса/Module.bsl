...
Процедура КомандаОК(Команда)
	...
	Если Модифицированность Тогда
        ...
        Если ЧастиАдреса.НаселенныйПункт.Наименование="Минск" Тогда
            ЧастиАдреса.Регион.Значение = "";
            ЧастиАдреса.Регион.Наименование = "";
         КонецЕсли;     
        //}}1C-Минск
...
Процедура ПостроитьФормуПоЧастямАдреса()
	...
	Для Каждого КлючЗначение Из ЧастиАдреса Цикл
        ...
        //{{1С-Минск
        Если Найти(Элемент.Имя, "Регион") > 0 Тогда
            Элемент.Заголовок = "Область";
        КонецЕсли;     
        Если Найти(Элемент.Имя, "Город") > 0 Тогда
            Элемент.Заголовок = "Сельсовет";
        КонецЕсли;     
        //}}1C-Минск
	КонецЦикла;
