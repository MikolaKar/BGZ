...
//
// В качестве значения выбора возвращается:
//     При отказе от выбора - неопределено
//     При успешном выборе  - структура с полями Код, Представление с данными классификатора
//
