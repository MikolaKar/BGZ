...
Процедура ПроверитьПодключениеFILE(Команда)
	...
	Запросы = СоздатьЗапросНаИспользованиеВнешнихРесурсов(Объект,, Истина);
...
Процедура КакОпределитьПараметрыПодключенияКВебСервису(Команда)
	...
	ОткрытьФорму("Обработка.ПомощникСозданияОбменаДанными.Форма.ДополнительноеОписание", ПараметрыФормы, ЭтотОбъект);
...
Процедура УстановитьТекстРезервногоКопирования()
	...
	Текст = ФорматДок.ПолучитьФорматированнуюСтроку();
	
	Элементы.НадписьРезервноеКопирование.Заголовок       = Текст;
	Элементы.НадписьРезервноеКопированиеСервис.Заголовок = Текст;
КонецПроцедуры
...
Функция СоздатьЗапросНаИспользованиеВнешнихРесурсов(Знач Объект, ЗапрашиватьCOM = Ложь,
	ЗапрашиватьFILE = Ложь, ЗапрашиватьWS = Ложь, ЗапрашиватьFTP = Ложь)
...
Процедура РежимРаботыМастераПриИзмененииНаСервере()
	...
	ЗначенияНастроек.Вставить("Картинки",      Элементы.КартинкаДляОбменаЧерезВнешнееСоединение);
	...
	ЗначенияНастроек = Новый Структура;
	ЗначенияНастроек.Вставить("Картинки",      Элементы.КартинкаДляОбменаЧерезОбычныеКаналыСвязи);
	...
	ЗначенияНастроек = Новый Структура;
	ЗначенияНастроек.Вставить("Картинки",      Элементы.КартинкаДляОбменаЧерезВебСервис);
	...
	Для Каждого КлючЗначение Из ВсеНастройкиСтраниц Цикл
		...
		Если ЗначенияНастроек.Использование Тогда
			Если ВариантНастроек = РежимРаботыМастера Тогда
				Элементы.КартинкиВыбораРежимаРаботыПомощника.ТекущаяСтраница = ЗначенияНастроек.Картинки;
...
Функция Подключаемый_СтраницаМастераНачало_ПриПереходеДалее(Отказ)
	...
	ТекстПредупреждения = НСтр("ru = 'Для передачи файла настроек синхронизации данных необходимо установить расширение работы с файлами.'");
...
Процедура ТаблицаПереходовНастройкиОбменаЧерезВнешнееСоединение()
	...
	ТаблицаПереходовНоваяСтрока(1, "СтраницаМастераНачало",                                             "", "СтраницаНавигацииНачало");
	ТаблицаПереходовНоваяСтрока(2, "СтраницаМастераВыборРежимаРаботыПомощника",                         "", "СтраницаНавигацииПродолжение", "СтраницаМастераВыборРежимаРаботыПомощника_ПриПереходеДалее");
...
Процедура ТаблицаПереходовНастройкиОбменаЧерезВебСервис()
	...
	ТаблицаПереходовНоваяСтрока(5, "СтраницаМастераПараметрыПолученияДанных",, "СтраницаНавигацииПродолжение", "СтраницаМастераПараметрыПолученияДанных_ПриПереходеДалее");
	
	// Создание настройки обмена; Регистрация справочников для выгрузки
	ТаблицаПереходовНоваяСтрока(6,  "СтраницаМастераОжиданиеАнализаДанныхСозданиеНастройкиОбмена",  "", "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеАнализаДанныхСозданиеНастройкиОбмена_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(7,  "СтраницаМастераОжиданиеАнализаДанныхСозданиеНастройкиОбмена",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеАнализаДанныхСозданиеНастройкиОбменаДлительнаяОперация_ОбработкаДлительнойОперации");
	
	// Получение справочников от корреспондента
	ТаблицаПереходовНоваяСтрока(8,  "СтраницаМастераОжиданиеАнализаДанныхПолучениеСообщения",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеАнализаДанныхПолучениеСообщения_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(9,  "СтраницаМастераОжиданиеАнализаДанныхПолучениеСообщения",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеАнализаДанныхПолучениеСообщенияДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(10,  "СтраницаМастераОжиданиеАнализаДанныхПолучениеСообщения",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеАнализаДанныхПолучениеСообщенияДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	
	// Выполнение автоматического сопоставления данных; Получение статистики сопоставления
	ТаблицаПереходовНоваяСтрока(11, "СтраницаМастераОжиданиеАнализаДанныхАвтоматическоеСопоставление",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеАнализаДанныхАвтоматическоеСопоставление_ОбработкаДлительнойОперации");
	
	// Ручное сопоставление данных
	ТаблицаПереходовНоваяСтрока(12, "СтраницаМастераСопоставлениеДанных",, "СтраницаНавигацииПродолжениеТолькоДалее", "СтраницаМастераСопоставлениеДанных_ПриПереходеДалее",, "СтраницаМастераСопоставлениеДанных_ПриОткрытии");
	
	// Синхронизация справочников
	ТаблицаПереходовНоваяСтрока(13, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииСправочниковЗагрузка_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(14, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииСправочниковВыгрузка_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(15, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииСправочниковВыгрузкаДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(16, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииСправочниковВыгрузкаДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	
	// Настройки параметров учета
	ТаблицаПереходовНоваяСтрока(17, "СтраницаМастераНастройкиОтраженияДокументовВУчете",, "СтраницаНавигацииПродолжениеТолькоДалее", "СтраницаМастераНастройкиОтраженияДокументовВУчете_ПриПереходеДалее",, "СтраницаМастераНастройкиОтраженияДокументовВУчете_ПриОткрытии");
	
	// Сохранение настроек; Регистрация всех данных к выгрузке, кроме справочников
	ТаблицаПереходовНоваяСтрока(18, "СтраницаМастераОжиданиеСохраненияНастроек",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСохраненияНастроек_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(19, "СтраницаМастераОжиданиеСохраненияНастроек",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСохраненияНастроекДлительнаяОперация_ОбработкаДлительнойОперации");
	
	// Синхронизация всех данных, кроме справочников
	ТаблицаПереходовНоваяСтрока(20, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииДанныхЗагрузка_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(21, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииДанныхЗагрузкаДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(22, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииДанныхЗагрузкаДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(23, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииДанныхВыгрузка_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(24, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииДанныхВыгрузкаДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрока(25, "ОжиданиеСинхронизацииДанных",, "СтраницаНавигацииОжидание",,,, Истина, "СтраницаМастераОжиданиеСинхронизацииДанныхВыгрузкаДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
	
	ТаблицаПереходовНоваяСтрока(26, "СтраницаМастераСозданиеОбменаДаннымиУспешноЗавершено",, "СтраницаНавигацииОкончание",,, "СтраницаМастераСозданиеОбменаДаннымиУспешноЗавершено_ПриОткрытии");
...
Процедура ТаблицаПереходовРасширеннойНастройкиОбменаССервисом()
	...
	// Значения по умолчанию при загрузке данных
	ТаблицаПереходовНоваяСтрока(4, "СтраницаМастераПараметрыПолученияДанных",, "СтраницаНавигацииПродолжение", "СтраницаМастераПараметрыПолученияДанных_ПриПереходеДалее");
