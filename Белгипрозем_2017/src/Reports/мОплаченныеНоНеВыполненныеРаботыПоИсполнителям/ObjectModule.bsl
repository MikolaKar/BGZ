...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    мУправлениеКолонтитулами.УстановитьКолонтитулы(ДокументРезультат, "мОплаченныеНоНеВыполненныеРаботыПоИсполнителям");
	...
	ДокументРезультат.НижнийКолонтитул.НачальнаяСтраница = 2;
  	ДокументРезультат.КлючПараметровПечати = "мОплаченныеНоНеВыполненныеРаботыПоИсполнителям";
