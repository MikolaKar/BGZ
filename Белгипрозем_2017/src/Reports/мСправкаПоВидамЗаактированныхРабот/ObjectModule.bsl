...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    мУправлениеКолонтитулами.УстановитьКолонтитулы(ДокументРезультат, "мСправкаПоВидамЗаактированныхРабот");
    ...
    ДокументРезультат.КлючПараметровПечати = "мСправкаПоВидамЗаактированныхРабот";
