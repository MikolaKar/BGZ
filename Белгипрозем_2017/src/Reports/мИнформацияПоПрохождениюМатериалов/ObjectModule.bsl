...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    мУправлениеКолонтитулами.УстановитьКолонтитулы(ДокументРезультат, "мИнформацияПоПрохождениюМатериалов");
    ...
    ДокументРезультат.КлючПараметровПечати = "мИнформацияПоПрохождениюМатериалов";
