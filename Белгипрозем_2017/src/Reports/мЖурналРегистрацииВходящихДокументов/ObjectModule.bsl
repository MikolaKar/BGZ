...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    мУправлениеКолонтитулами.УстановитьКолонтитулы(ДокументРезультат, "мЖурналРегистрацииВходящихДокументов");
    ...
    СтруктураПараметровДляВывода = Новый Структура("ПоказыватьДокументы, ПоказыватьПомеченныеНаУдаление, СписокКатегорий");
