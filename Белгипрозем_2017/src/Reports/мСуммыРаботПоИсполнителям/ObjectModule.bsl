...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    мУправлениеКолонтитулами.УстановитьКолонтитулы(ДокументРезультат, "мСуммыРаботПоИсполнителям");
    ...
    ДокументРезультат.КлючПараметровПечати = "мСуммыРаботПоИсполнителям";
    ...
    СтруктураПараметровДляВывода = Новый Структура("Исполнитель, Подразделение");
