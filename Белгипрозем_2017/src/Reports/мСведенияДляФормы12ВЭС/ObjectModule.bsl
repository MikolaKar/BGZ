...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    мУправлениеКолонтитулами.УстановитьКолонтитулы(ДокументРезультат, "мСведенияДляФормы12ВЭС");
    ...
    ДокументРезультат.НижнийКолонтитул.НачальнаяСтраница = 2;
  	ДокументРезультат.КлючПараметровПечати = "мСведенияДляФормы12ВЭС";
    ...
    //СтруктураПараметровДляВывода = Новый Структура("ВидЗаказчика");
