...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    мУправлениеКолонтитулами.УстановитьКолонтитулы(ДокументРезультат, "мСтоимостьОтправкиБрест");
    ...
    ДокументРезультат.КлючПараметровПечати = "мСтоимостьОтправкиБрест";
    ...
    СтруктураПараметровДляВывода = Новый Структура("Ответственный, ВидДокумента, НачНомер, КонНомер, ПоказыватьДокументы");
