...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
    ...
    мУправлениеКолонтитулами.УстановитьКолонтитулы(ДокументРезультат, "мОриентировочныйОбъемВыполнения");
	...
	ДокументРезультат.НижнийКолонтитул.НачальнаяСтраница = 2;
  	ДокументРезультат.КлючПараметровПечати = "мОриентировочныйОбъемВыполнения";
    ...
    СтруктураПараметровДляВывода = Новый Структура("Подразделение, ПериодАктирования");
