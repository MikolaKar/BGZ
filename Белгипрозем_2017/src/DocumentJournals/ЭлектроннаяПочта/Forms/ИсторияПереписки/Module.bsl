...
Процедура ЗаполнитьУзелДереваПереписки(ЭлементыДерева, ПисьмоРодитель, Знач КорневойУровень)
	...
	Если ВстроеннаяПочтаКлиентСервер.ЭтоВходящееПисьмо(ПисьмоРодитель) Тогда
		...
		РеквизитыПисьма = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(
			ПисьмоРодитель,
			"Дата, ОтправительАдресат, Тема, ЕстьВложения, Размер, Важность");
	...
	ИначеЕсли ВстроеннаяПочтаКлиентСервер.ЭтоИсходящееПисьмо(ПисьмоРодитель) Тогда
		...
		РеквизитыПисьма = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(
			ПисьмоРодитель,
			"Дата, Тема, ЕстьВложения, Размер, Важность, УчетнаяЗапись");
	...
	ИначеЕсли ДелопроизводствоКлиентСервер.ЭтоВходящийДокумент(ПисьмоРодитель) Тогда
		...
		РеквизитыПисьма = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(
			ПисьмоРодитель,
			"ДатаРегистрации, Подписал, Отправитель, Заголовок, Адресат");
	...
	ИначеЕсли ДелопроизводствоКлиентСервер.ЭтоИсходящийДокумент(ПисьмоРодитель) Тогда
		...
		РеквизитыПисьма = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(
			ПисьмоРодитель,
			"ДатаРегистрации, Подписал, Подготовил, Заголовок");
...
Процедура ОбновитьПоложениеОбластиЧтенияСервер()
	...
	Если ПоложениеОбластиЧтения = "Снизу" Тогда
		...
		Элементы.ГруппаПредпросмотр.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Горизонтальная;
	...
	ИначеЕсли ПоложениеОбластиЧтения = "Справа" Тогда
		Элементы.ПредпросмотрHTML.Видимость = Истина;
		Элементы.Вложения.Видимость = Истина;
		Элементы.ГруппаПредпросмотр.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
