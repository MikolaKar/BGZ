...
Процедура ПриЗакрытии()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(ЭтаФорма.ИмяФормы, "УчетнаяЗапись", УчетнаяЗапись);
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(ЭтаФорма.ИмяФормы, "Папка", Папка);
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(ЭтаФорма.ИмяФормы, "ПапкаMicrosoftOutlook", ПапкаMicrosoftOutlook);
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(ЭтаФорма.ИмяФормы, "ПомечатьКакПрочитанные", ПомечатьКакПрочитанные);
...
Процедура УстановитьСвязьСОснованием(Письмо)
	...
	Иначе
		...
		УчетнаяЗапись = ОбщегоНазначения.ПолучитьЗначениеРеквизита(Письмо, "УчетнаяЗапись");
...
Процедура УчетнаяЗаписьПриИзменении(Элемент)
	Если ЗначениеЗаполнено(УчетнаяЗапись) Тогда		
		МоиАдреса = ОбщегоНазначения.ПолучитьЗначениеРеквизита(УчетнаяЗапись, "АдресЭлектроннойПочты");
	КонецЕсли;	
КонецПроцедуры
