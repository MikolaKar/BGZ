...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ТипЗнч(Параметры.Письмо) = Тип("Структура") Тогда
		...
		ДанныеФайлов = РеквизитФормыВЗначение("СтруктураПисьма.ФайлыПисьма", Тип("ТаблицаЗначений")); 
	...
	Если ЗначениеЗаполнено(ПапкаДляТекстаПисьма) Тогда
		ПолноеИмяФайлаДляТекста = ПапкаДляТекстаПисьма + НаименованиеФайлаТекстаПисьма + ".txt";
	КонецЕсли;
...
Процедура НаименованиеФайлаТекстаПисьмаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ВыборФайла.Выбрать() Тогда
		...
		НаименованиеФайлаТекстаПисьма = Лев(ВыбранноеИмяСРасширением, СтрДлина(ВыбранноеИмяСРасширением)-4);
	КонецЕсли;
...
Процедура НаименованиеФайлаТекстаПисьмаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ВыбранноеЗначение = ПапкаДляТекстаПисьма + НаименованиеФайлаТекстаПисьма + ".txt";
...
Процедура Выгрузить(Команда)
	...
	Если ЗначениеЗаполнено(ПолноеИмяФайлаДляТекста) Тогда
		...
		ИмяФайлаСРасширением = ФайловыеФункцииКлиентСервер.ПолучитьИмяСРасширением(НаименованиеФайлаТекстаПисьма, "txt");
